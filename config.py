...
for prompt_name in [
    ...
    with open(f"prompts/{prompt_name}.yaml", 'r') as stream:
        prompt_templates = yaml.safe_load(stream)
        prompts[prompt_name] = prompt_templates
...
configs = {
    "websearch_agent": {
        ...
        "prompt_templates": prompts["websearch_agent"],
        "max_steps": 5
    },
    "google_map_agent": {
        "model": "gpt-4o-mini",
        ...
        "prompt_templates": prompts["google_map_agent"],
        "max_steps": 5
    },
    "image_generation_agent": {
        "model": "gpt-4o-mini",
        ...
        "prompt_templates": prompts["image_generation_agent"]
    },
    "professional_agent": {
        "model": "gpt-4o-mini",
        ...
        "prompt_templates": prompts["professional_agent"],
        "max_steps": 5
    },
    "master_agent": {
        "model": "gpt-4o-mini",
        ...
        "prompt_templates": prompts["master_agent"]
    }
}